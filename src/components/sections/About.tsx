    ...
    <section id="about" ref={sectionRef} className="w-full max-w-[1280px] mx-auto px-6 sm:px-14 py-24 min-h-[70vh]">
      ...
      >
        ...
        <div className="flex flex-col">
          <h2 className="font-fraunces font-medium text-[clamp(28px,3vw,44px)] text-navy leading-[1.1] mb-8">
            The person behind <br />
            <span className="italic text-accent-blue font-light">the code.</span>
          </h2>
          
          <div className="space-y-5 text-[15px] font-light text-darkest leading-[1.7]">
            <p>
          ...
          <div className="mt-12">
            <h3 className="text-[12px] uppercase tracking-widest text-muted mb-4 font-medium">Currently Exploring</h3>
            <div className="flex flex-wrap gap-2.5">
              {['AI tooling', 'shader interfaces', 'interaction systems', 'developer ergonomics'].map((tag) => (
                <span key={tag} className="font-mono text-[11px] px-3 py-1.5 bg-soft-blue/10 border border-soft-blue/30 rounded text-navy">
                  {tag}
                </span>
              ))}
            </div>
        ...
        <div className="flex flex-col gap-5 mt-6 lg:mt-0">
          <Card className="p-6 transition-transform hover:-translate-y-1 duration-300">
            <div className="w-10 h-10 rounded-lg bg-soft-blue/20 flex items-center justify-center text-xl mb-4">⚡</div>
            <h4 className="font-medium text-navy text-[16px] mb-2">Performance matters</h4>
          ...
          <Card className="p-6 transition-transform hover:-translate-y-1 duration-300 ml-0 lg:ml-6">
            <div className="w-10 h-10 rounded-lg bg-soft-blue/20 flex items-center justify-center text-xl mb-4">✨</div>
            <h4 className="font-medium text-navy text-[16px] mb-2">Design should feel alive</h4>
            <p className="text-sm font-light text-muted leading-relaxed">
          ...
          <Card className="p-6 transition-transform hover:-translate-y-1 duration-300 ml-0 lg:ml-12">
            <div className="w-10 h-10 rounded-lg bg-soft-blue/20 flex items-center justify-center text-xl mb-4">🔁</div>
            <h4 className="font-medium text-navy text-[16px] mb-2">Build fast, refine continuously</h4>
            <p className="text-sm font-light text-muted leading-relaxed">
